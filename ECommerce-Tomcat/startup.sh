...
apachectl start;
java "${JAVA_OPTS}" -javaagent:${CATALINA_HOME}/appagent/javaagent.jar  -cp ${CATALINA_HOME}/bin/bootstrap.jar:${CATALINA_HOME}/bin/tomcat-juli.jar org.apache.catalina.startup.Bootstrap
