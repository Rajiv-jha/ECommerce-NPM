...
sed -i "s/127.0.0.1/${IP_ADDRESS}/g" /opt/survey-client/appagent/$k/external-services/npm/npm-service.properties
sed -i "s/localhost/${IP_ADDRESS}/g" /opt/survey-client/appagent/$k/external-services/npm/npm-service.properties
